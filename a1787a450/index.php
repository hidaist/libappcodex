        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-building"></i>Tempat </a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-building-o"></i><a href="?page=views&views=rakBukuView">Rak Buku</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown ">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-users"></i><a href="?page=views&views=pinjamBukuView">Peminjam Buku</a></li>
                            <li><i class="fa fa-table"></i><a href="?page=views&views=ProsesKembaliBukuView">Proses Pengembalian </a></li>
    ...
    <div id="right-panel" class="right-panel ">
        ...
        <div class="content mt-3">
            ...
            <div class="col-xl-3 col-lg-6 searchable-item">
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one"><a href='?page=views&views=bukuView'>
                            <div class="stat-icon dib"><i class="ti-layout-grid2 bg-flat-color-5  float-left text-light"></i></div>
                            <div class="stat-content dib">
                                <div class="stat-text">Total Buku</div>
                                <div class="stat-digit">
                                    <?php 
                                        $sqlJmlbuku = mysqli_query($koneksi," SELECT COUNT(kd_buku) AS Jumlah_buku FROM tb_lib_buku;");
                                        $dataJmlBuku = mysqli_fetch_array($sqlJmlbuku);

                                        echo $dataJmlBuku['Jumlah_buku'];
                                    ?> 
                                    </div>
                            </div>
                        </div></a>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one"><a href='?page=views&views=pinjamBukuView'>
                            <div class="stat-icon dib"><i class="ti-user bg-danger text-light"></i></div>
                            <div class="stat-content dib">
                                ...
                                <?php 
                                    $sqlPeminjamanBuku = mysqli_query($koneksi,"SELECT 
                                            ...
                                            WHERE tb_lib_pengembalian.kd_pinjam IS NULL");
