            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header" align="center">
                        <strong class="card-title"> Data Rekap Peminjaman & Pengembalian Buku </strong>
                    </div>
                    ...
                    <table id="table_buku" class="display responsive">
                            ...
                            <?php 
                                $no = 1;
                                while ($row = mysqli_fetch_assoc($sqlProsesPinjamBuku)): ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><?= $row['kd_pinjam']; ?></td>
                                        <td><?= $row['isbn']; ?></td>
                                        ...
                                        <td><a class="fa fa-exchange" href="?page=forms&forms=pengembalianBukuForm&kdpinjam=<?= $row['kd_pinjam'] ;?>"> Proses Pengembalian</a> </td>
