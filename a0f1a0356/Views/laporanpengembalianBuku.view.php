...
$sqlkembali = mysqli_query($koneksi,"SELECT tb_lib_users.nama,tb_lib_users.kd_user,tb_lib_users.id,tb_lib_peminjaman.date_pinjam,tb_lib_buku.judul_buku,tb_lib_buku.isbn,tb_lib_pengembalian.date_kembali,
